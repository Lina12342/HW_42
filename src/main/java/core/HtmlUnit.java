...
HtmlPage index_page = driver.getPage(p.getProperty("url")); // HEADER System.out.println("#,Browser,Page,Field,isPresent,Value"); report.write("#,Browser,Page,Field,isPresent,Value"); report.write(ls); HtmlForm form = index_page.getFormByName(p.getProperty("form"));
// 01 :: First Name report.write("01,HtmlUnit,index.php,First Name," + isElementPresentHtmlUnit(index_page, p.getProperty("fname_id")) + "," + p.getProperty("fname_value") + "\n"); System.out.print("01,HtmlUnit,index.php,First Name," + isElementPresentHtmlUnit(index_page, p.getProperty("fname_id")) + "," + 
